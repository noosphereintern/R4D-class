...
```{r}
check_numbers01 <- function(num_vec01a, num_vec01b, error_message = "This function only accepts numeric inputs") {
    if (is.numeric(num_vec01a) & is.numeric(num_vec01b)) {
        # value to be return if numeric
        sum(num_vec01a, num_vec01b, na.rm = T) 
    } else {
        # value that is returned if it is not numeric
        stop(error_message)
    }
...
```{r}
check_numbers01(num_vec01a = 4, num_vec01b = 8)
```
```{r}
check_numbers01(num_vec01a = 4, num_vec01b = "reaihias")
```
...
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 1)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 2)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 3)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 4)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 5)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 6)
read_xlsx("../data/UN_MigrantStockTotal_2017.xlsx", 7)
#use excel_sheeets next time?
#or not, that just reads the name of the sheets and stashes them in a vector
```
